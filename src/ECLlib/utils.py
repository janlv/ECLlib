...
#--------------------------------------------------------------------------------------------------
    # From Itertools Recipes at docs.python.org
...
#--------------------------------------------------------------------------------------------------  
    ...
    if major is not None and minor is not None:
        if sysmajor < major or (sysmajor == major and sysminor < minor):
            # Use old formatting to make function valid for old python
            # pylint: disable=consider-using-f-string
            stderr.write(
                "\n[WARNING] This script requires Python {}.{} or higher, "
